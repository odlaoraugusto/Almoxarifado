...
/** Campo de busca com sugestões — genérico para não duplicar a mesma
 * lógica de filtro/abrir-fechar em cada tela que precisa buscar um item
 * do catálogo (formulário público de solicitação, Entrada de estoque). */
