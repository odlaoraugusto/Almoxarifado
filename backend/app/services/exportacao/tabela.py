...
class TabelaRelatorio:
    ...
    # Linhas de fechamento exibidas após a tabela (ex.: totais).
    rodape: list[str] = field(default_factory=list)

    # Peso relativo de cada coluna (mesma ordem de `colunas`) — usado só
    # pelo PDF para dar mais espaço a colunas com texto mais longo. `None`
    # = todas as colunas com a mesma largura.
