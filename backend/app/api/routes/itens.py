...
# Cadastro/edição do catálogo — exclusivo do Coordenador (matriz de
# permissões, docs/00_PROJETO_ALMOXARIFADO.md seção 3.3). Entrada de
# estoque é liberada para qualquer perfil autenticado (Atendente e
# Coordenador recebem compra/doação no dia a dia).
_PODE_CADASTRAR = exigir_perfis(PerfilEnum.coordenador)
