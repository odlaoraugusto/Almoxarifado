"""Monta a `StreamingResponse` de download (PDF/Excel) compartilhada pelos
endpoints de `/relatorios/*` — cada endpoint só monta a `TabelaRelatorio`
(via `relatorio_tabela_builder`) e delega o resto aqui."""
